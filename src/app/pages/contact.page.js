    ...
    return (
        <div className="text-light">
            ...
            <Row className="p-0 m-0">
                <Col md={6}>
                    <Row className="p-0 m-0">
                        <Col className="text-light text-center text-shadow py-3" tag={"h4"}>Contact Information</Col>
                    </Row>
                    <Row className="p-0 m-0">
                        <Col md={3}>
                            <Card className="bg-dark border-0 my-3">
                                <CardImg top className="p-2" width="100%" src={AddressImage} alt="Card image cap" />
                            </Card>
                        </Col>
                        <Col md={9}>
                            <Row className="p-0 m-0">
                                <Col className="text-primary py-3 text-shadow" tag="h5">Address</Col>
                            </Row>
                            <Row className="p-0 m-0 text-shadow">
                                <span className="pl-3" tag="p">Main Office:</span>
                    ...
                    <Row className="p-0 m-0">
                        ...
                        <Col md={9}>
                            <Row className="p-0 m-0">
                                <Col className="text-primary py-3 text-shadow" tag="h5">Phone Numbers</Col>
                            </Row>
                            <Row className="p-0 m-0 pb-3 text-shadow">
                                <Col md={6}>
                                    <Row className="pl-3" tag="p">Main Office:</Row>
                                </Col>
                                <Col md={6}>
                            ...
                            <Row className="p-0 m-0 pb-3 text-shadow">
                                <Col md={6}>
                                    <Row className="pl-3" tag="p">Yosheel Murugasen:</Row>
                                </Col>
                                <Col md={6}>
                            ...
                            <Row className="p-0 m-0 pb-3 text-shadow">
                                <Col md={6}>
                                    <Row className="pl-3" tag="p">Mervin Murugasen:</Row>
                                </Col>
                                <Col md={6}>
                    ...
                    <Row className="p-0 m-0 text-shadow">
                        ...
                        <Col md={9}>
                            <Row className="p-0 m-0">
                                <Col className="text-primary py-3 text-shadow" tag="h5">Email Address</Col>
                            </Row>
                            <Row className="p-0 m-0 text-shadow">
                                <Col md={6}>
                                    <Row className="pl-3 text-shadow" tag="p">Customer Support:</Row>
                                </Col>
                                <Col md={6}>
                    ...
                    <Row className="p-0 m-0">
                        ...
                        <Col md={9}>
                            <Row className="p-0 m-0">
                                <Col className="text-primary py-3 text-shadow" tag="h5">Social Media</Col>
                            </Row>
                ...
                <Col md={6}>
                    <Row className="p-0 m-0">
                        <Col className="text-light text-center py-3 text-shadow"tag={"h4"}>Get In Touch</Col>
                    </Row>
                    <Row className="p-0 m-0">
                        <ContactForm />
                    </Row>
