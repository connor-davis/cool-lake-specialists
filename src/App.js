  ...
  return (
    <>
      <div className="app text-light">
        <Router>
          <Container>
            <Navbar dark expand="md" className="p-2" style={{background: "transparent"}}>
              <NavbarBrand tag={Link} to="/">
                <img
                  src={Logo}
                  alt="Cool Lake Specialst CC"
                  style={{ width: "auto", height: "auto" }}
                />
              </NavbarBrand>
              <NavbarToggler onClick={toggle} />
              <Collapse isOpen={isOpen} navbar>
                <Nav className="text-center text-shadow text-muted" navbar>
                  <NavItem>
                    <NavLink tag={Link} to="/">
                      Home
                    </NavLink>
            ...
            <Switch>
              ...
              <Route
                path="/services"
                component={(props) => <ServicesHomePage {...props} />}
              />
              <Route
                path="/supplies"
                component={(props) => <SuppliesHomePage {...props} />}
              />
              <Route
                path="/contact"
